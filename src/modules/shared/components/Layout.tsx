        ...
        <div className="block lg:hidden bg-white shadow-sm border-b border-gray-200">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded-lg px-3 py-2 transition-colors"
            >
