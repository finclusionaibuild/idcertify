...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-80 bg-primary-600 transform transition-transform duration-300 ease-in-out flex flex-col lg:translate-x-0 lg:static lg:inset-0 mt-16
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col lg:ml-0 mt-16">
        {/* Mobile header */}
